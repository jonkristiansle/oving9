"""
@authors: Ole Berg Sylte, Stian Kolnes, Edward Larsen og Jon Slettebø
"""
...
class Kategori:
    def __init__(self, id_n, navn, prioritet=1):
        self.id_n = id_n
        self.navn = navn
        self.prioritet = prioritet

    def __str__(self):
        return f"Avtalens id: {self.id_n}, avtalens navn: {self.navn}, avtalens prioritet: {self.prioritet}"


def leserinn():
    id_n = input("Skriv inn avtalens id: ")
    navn = input("Skriv inn avtalens navn: ")
    prioritet = int(input("Skriv inn avtalens prioritet: "))
    return Kategori(id_n, navn, prioritet)
